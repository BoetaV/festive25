...
MIDDLEWARE = [
    ...
    'accounts.middleware.ActiveUserMiddleware', # <-- THIS WAS MISSING
...
IS_PRODUCTION = 'RENDER' in os.environ # Render sets this env var automatically
